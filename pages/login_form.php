            ...
            <div class="form-bottom">
                <form role="form" action="index.php?page=accounts&action=register" method="POST" class="registration-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="birthday" placeholder="Birthday..." class="form-birthday form-control" id="form-email">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="form-email">Phone number</label>
                        <input type="text" name="phone" placeholder="Phone number..." class="form-phonenumber form-control" id="form-email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" placeholder="Password..." class="form-password form-control" id="form-email">
                    </div>
